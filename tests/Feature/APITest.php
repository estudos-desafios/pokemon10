...
class APITest extends TestCase
{
    ...
    /** @test */
    public function pokemon_list_is_ok(): void
    {
        $this->markTestSkipped('This test is skipped.');
    ...
    {
        $this->markTestSkipped('This test is skipped.');
        $this->getJson('/api/v1/pokemons/?query=')
            ->assertStatus(400);
    }
    ...
    {
        $this->markTestSkipped('This test is skipped.');
        $this->getJson('/api/v1/pokemons/?query=Alien')
            ->assertStatus(404);
    }
    ...
    {
        $this->markTestSkipped('This test is skipped.');
        $this->getJson('/api/v1/pokemons/?query=grass')
            ->assertStatus(200)
            ->assertJsonFragment(['name' => 'bulbasaur']);
    }
    ...
    {
        $this->markTestSkipped('This test is skipped.');
        $this->getJson('/api/v1/pokemons/?name=123')
            ->assertStatus(400);
    }
    ...
    {
        $this->markTestSkipped('This test is skipped.');
        $this->getJson('/api/v1/pokemons/?type=!@#')
            ->assertStatus(400);
    }
    
    /** @test */
    public function check_status_and_structure_by_search_name_or_type()
    {
        $this->markTestSkipped('This test is skipped.');
        Pokemon::factory()->create([
            'name' => 'Bulbasaur',
        ...
        $this->getJson('/api/v1/pokemons/?name=Bulbasaur&type=Grass')
            ->assertStatus(200)
            ->assertJsonFragment(['name' => 'Bulbasaur']);
    }
    ...
    public function check_status_and_count_itens_is_correct()
    {
        ...
        $this->getJson('/api/v1/pokemons?page=3')
            ->assertStatus(200)
            ->assertJsonCount(5, 'pokemons'); // A última página deve ter apenas 5 itens
    }
